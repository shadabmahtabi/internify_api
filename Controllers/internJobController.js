...
exports.updateInternship = catchAsyncErrors(async (req, res, next) => {
    ...
    const internship = await internshipModel.findByIdAndUpdate(req.params.internId, req.body).exec();
...
exports.readSingleInternship = catchAsyncErrors(async (req, res, next) => {
    ...
    const internship = await internshipModel.findOne({_id: req.params.internId}).exec();
...
exports.applyinternship = catchAsyncErrors(async (req, res, next) => {
    ...
    application.questions.push({question: req.body.question1, answer: req.body.answer1})
...
exports.updatejob = catchAsyncErrors(async (req, res, next) => {
    ...
    const job = await jobModel.findByIdAndUpdate(req.params.jobId, req.body).exec();
